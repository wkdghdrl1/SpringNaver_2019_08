...
public class NaverController {
	...
	public String naver(@RequestParam String category, 
...
//		String jsonString = nService.getJsonString(category, search_text);
	...
	@ResponseBody
	@RequestMapping(value = "json", method =RequestMethod.GET, produces = "text/json;charset=UTF-8")
	public String naver_json(Model model) {
